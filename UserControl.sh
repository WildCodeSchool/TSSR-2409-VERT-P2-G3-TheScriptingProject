...
$Exe_script_Parefeu = 'powershell -ExecutionPolicy Bypass -File "C:\Users\wilder\GestionParefeu.ps1"'
$Delete_script = 'Remove-Item "C:\Users\wilder\GestionParefeu.ps1"'
                    ...
                    "1" {
                        ...
                        while ($true) {
                            ...
                            switch ($gestion) {
                                ...
                                "7" { 
                                    scp C:\script_action\GestionParefeu.ps1 ${user1}:/C:/Users/wilder/GestionParefeu.ps1
                                    ssh -t $user1 $Exe_script_Parefeu
                                    ssh -t $user1 $Delete_script
                                }
                                "8" { 
