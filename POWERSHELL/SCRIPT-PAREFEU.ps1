...
while ($true) {
    Write-Host "------ MENU GESTION PARE-FEU ------`n" -ForegroundColor $GREEN
    Write-Host "[1] " -ForegroundColor $YELLOW -NoNewline; Write-Host "Définir les règles de pare-feu" -ForegroundColor $NC
    Write-Host "[2] " -ForegroundColor $YELLOW -NoNewline; Write-Host "Activer le pare-feu" -ForegroundColor $NC
    Write-Host "[3] " -ForegroundColor $YELLOW -NoNewline; Write-Host "Désactiver le pare-feu" -ForegroundColor $NC
    Write-Host "[4] " -ForegroundColor $YELLOW -NoNewline; Write-Host "Retour au menu principal" -ForegroundColor $NC
    Write-Host "[x] " -ForegroundColor $RED -NoNewline; Write-Host "Quitter`n" -ForegroundColor $NC
    ...
    switch ($choix) { 
        ...
        "1" {
            while ($true) {
                Write-Host "------ MENU DES RÈGLES PARE-FEU ------`n" -ForegroundColor $GREEN
                Write-Host "[1] " -ForegroundColor $YELLOW -NoNewline; Write-Host "Ajouter une règle" -ForegroundColor $NC
                Write-Host "[2] " -ForegroundColor $YELLOW -NoNewline; Write-Host "Supprimer une règle" -ForegroundColor $NC
                Write-Host "[3] " -ForegroundColor $YELLOW -NoNewline; Write-Host "Afficher les règles actuelles" -ForegroundColor $NC
                Write-Host "[4] " -ForegroundColor $YELLOW -NoNewline; Write-Host "Retour au menu principal" -ForegroundColor $NC
                Write-Host "[x] " -ForegroundColor $RED -NoNewline; Write-Host "Quitter`n" -ForegroundColor $NC
